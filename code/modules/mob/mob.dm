...
/mob/proc/update_flavor_text()
	...
	if(usr != src)
		to_chat(usr, "No.")
	var/msg = input(usr,"Set the flavor text in your 'examine' verb. The flavor text should be a physical descriptor of your character that is only what people can observe about your character at a glance.","Flavor Text",html_decode(flavor_text)) as message|null
